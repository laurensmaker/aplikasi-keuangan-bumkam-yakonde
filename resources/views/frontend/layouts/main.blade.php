...
<head>
        ...
        <!-- title -->
        <title>Angels Cakes - Website</title>
        <!-- favicon -->
                            ...
                            <div class="quickview-main-area">
                                <div class="quickview-slider">
                                    <div class="swiper gallery-top">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="product-template.html"><img src="{{ asset('frontend/img/product/p-1.jpg') }}" class="img-fluid" alt="p-1"></a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="product-template.html"><img src="{{ asset('frontend/img/product/p-1.jpg') }}" class="img-fluid" alt="p-2"></a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="product-template.html"><img src="{{ asset('frontend/img/product/p-1.jpg') }}" class="img-fluid" alt="p-3"></a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="product-template.html"><img src="{{ asset('frontend/img/product/p-1.jpg') }}" class="img-fluid" alt="p-4"></a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="product-template.html"><img src="{{ asset('frontend/img/product/p-1.jpg') }}" class="img-fluid" alt="p-5"></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper gallery-thumbs">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="javascript:void(0)"><img src="{{ asset('frontend/img/product/p-1.jpg') }}" class="img-fluid" alt="p-1"></a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="javascript:void(0)"><img src="{{ asset('frontend/img/product/p-1.jpg') }}" class="img-fluid" alt="p-2"></a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="javascript:void(0)"><img src="{{ asset('frontend/img/product/p-1.jpg') }}" class="img-fluid" alt="p-3"></a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="javascript:void(0)"><img src="{{ asset('frontend/img/product/p-1.jpg') }}" class="img-fluid" alt="p-4"></a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="javascript:void(0)"><img src="{{ asset('frontend/img/product/p-1.jpg') }}" class="img-fluid" alt="p-5"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
